...
gkNextOutputs[]         init $SIZE      ; audio port to output
...
$SET_PARAM(SetOutputMsg'"SetOutputMsg"'"/set_output"'gkNextOutputs) 
...
opcode UpdateSyncedParams, 0, i
    ...
    gkOutputs[iChannel]         = gkNextOutputs[iChannel]
...
instr TheHeart
    ...
    outc  aL0, aR0, aL1, aR1, aL2, aR2, aL3, aR3, aL4, aR4, aL5, aR5
    clear gaL0, gaR0, gaL1, gaR1, gaL2, gaR2, gaL3, gaR3, gaL4, gaR4, gaL5, gaR5
endin
